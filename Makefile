...
lint-py:  ## lint python with ruff
	python -m ruff check hatch_cmake
	python -m ruff format --check hatch_cmake
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix hatch_cmake
	python -m ruff format hatch_cmake
...
test:  ## run python tests
	python -m pytest -v hatch_cmake/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v hatch_cmake/tests --cov=hatch_cmake --cov-report term-missing --cov-report xml
